...
<div align="center">
<a href="https://github.com/Skismail57/Skismail57/actions/workflows/snake.yml" title="Snake animation generated by GitHub Actions workflow (pink #ff2e88 snake)">
<object data="https://raw.githubusercontent.com/Skismail57/Skismail57/output/github-snake.svg?v=20260804" type="image/svg+xml" width="100%">
  <img src="https://ghchart.rshah.org/ff2e88/Skismail57?_v=20260804B" alt="Contribution heatmap (snake workflow runs on push + daily 03:00 UTC)" width="100%"/>
</object>
</a>
</div>

> Snake animation is generated automatically by the workflow in `.github/workflows/snake.yml` — triggers on push to `main` + daily at **03:00 UTC** + manual `workflow_dispatch`. Pushes to the `output` branch as **`github-snake.svg`** (palette: github-dark · custom pink snake `#ff2e88`) and `github-snake-light.svg` (palette: github-light · purple snake `#7b2ff7`). The pink heatmap above shows live data until the snake renders.
